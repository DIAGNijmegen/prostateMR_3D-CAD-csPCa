...
class Focal:
    ...
    Note: Function is Only Applicable for Binary Objectives.
    """
    ...
    def loss(self, y_true, y_pred):
        ...
        fl            = tf.math.multiply(tf.constant([self.alpha, 1-self.alpha]), tf.math.multiply(weight, ce))
...
class Weighted_Categorical_CE:
    ...
    def loss(self, y_true, y_pred):
        ...
        loss          = tf.keras.backend.sum(wce, -1)
        return loss